...
Still planned rather than claimed as complete: embedding retrieval, real Git-worktree transaction binding, adaptive cognitive routing with configurable Fast/Think model bindings, Graph Governor / Cortex Epochs, graph GC/hot-warm-cold storage, reusable Skills layer, vision/browser tooling and automatic split/merge canonicalization.
