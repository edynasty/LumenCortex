...
export default tool({
  description: "Inspect or checkpoint LumenCortex cognitive state. Use verify after source changes and commit only when a useful cognition change should persist.",
  args: {
