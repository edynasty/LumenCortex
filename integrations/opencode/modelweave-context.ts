...
export default tool({
  description: "Illuminate the smallest relevant ModelWeave context subgraph for the current coding question. Prefer this before broad repository exploration.",
  args: {
